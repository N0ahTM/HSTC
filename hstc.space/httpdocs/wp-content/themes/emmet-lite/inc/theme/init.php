    ...
    if ($isThemeActivation && !get_user_meta(get_current_user_id(), 'mp_emmet_wizard_dismiss', true)) {
        ...
        <div class="notice notice-success is-dismissible">
            ...
            <p><a class="button button-primary"
                  href="<?php echo esc_url($run_wizard_url); ?>"><strong><?php esc_html_e('Run Theme Wizard', 'emmet-lite'); ?></strong></a> <a class="button"
                                                                            href="<?php echo esc_url($skip_wizard_url); ?>"
...
function mp_emmet_wizard_dismiss()
{
    if ( isset( $_GET['mp-emmet-wizard-dismiss'] )
        && isset( $_GET['_wpnonce'] )
        && wp_verify_nonce( $_GET['_wpnonce'], 'theme_wizard_nonce' ) ) {
